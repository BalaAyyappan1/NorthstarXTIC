        ...
        <div className="flex md:flex-row flex-col justify-center items-start gap-12 h-full mt-2">
          ...
          <div className="flex-1 flex flex-col justify-center items-start space-y-6">
            ...
            <div className="space-y-2 text-white w-[454px] md:mt-0 mt-5">
              ...
              <p className="md:text-[36px] text-[20px] md:leading-[36px] leading-[26px] tracking-[-2px] font-semibold">
                Let's grow together
              </p>
              <div className="space-y-2 md:text-[36px] text-[20px] tracking-[-2px] text-[#A10E2B] font-semibold -mt-3.5 ">
                Join Our Northstar Team
              </div>
              <div className="flex flex-col md:space-y-4 space-y-0.5 text-white md:text-[16px] text-[10px] md:leading-[18px] font-normal">
