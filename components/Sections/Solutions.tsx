...
const Solutions = () => {
  ...
  return (
    <div id="Solutions-section" className="w-full py-10 px-4  max-w-7xl mx-auto">
      <h1 className="xl:text-[48px] lg:text-[35px] md:text-[38px] text-[20px] font-bold md:leading-[50px] leading-[24px] md:tracking-[-2px] tracking-[-1px] text-[#060B13] md:w-[696px] w-[300px] text-center justify-center items-center mx-auto">
      ...
      {/* Right side - Interactive Content - Now takes 50% width */}
